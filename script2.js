...
if(loggedIn){
  ...
  // Fetch the data for the current month from your database and update the table
  function updateTable() {
    // Replace this with your own code to fetch the data for the current month from your database
   
    const hoursWorked = ['10', '20', '40', '30', '15', '8', '25', '40', '77', '56', '49', '63']; // Replace with your own code to fetch the actual hours worked
    ...
    if (timeLeft === 0) {
      ...
      if (!isResting) {
        ...
        if(tasksArr.length == 0){
          ...
          if(gameIdx==1){
            restGame2.style.display = "none";
            restGame1.style.display = "flex";
          game();
          gameIdx=2;
          }
          else{ 
          restGame1.style.display = "none";
          restGame2.style.display = "flex";
          initializeGame();
          gameIdx=1;
          }
          timerLabel.innerText = 'PERTRAUKA';
      ...
      else {timerTaskName.innerText = 'Visos užduotys baigtos';
...
const game = () => {
  ...
  const playGame = () => {
      ...
      const computerOptions = ['akmuo','popierius','žirklės']
  ...
  const gameOver = (playerOptions,movesLeft) => {
      ...
      reloadBtn.innerText = 'Žaisti dar kartą';
