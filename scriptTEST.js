...
let timerInterval;
 let restTime = 6; // 2 seconds for demonstration purposes TEST VALUE
 ...
 let breakTime = 10;//PETRAUKA duration TEST VALUE
 let taskInx = 0;
...
workInput.addEventListener('input', () => {
  if(workInput.value<0.1)workInput.value=0.1;
...
breakInput.addEventListener('input', () => {
  if(breakInput.value<0.1)breakInput.value=0.1;
...
computerOptions = ['akmuo','popierius','žirklės'];
