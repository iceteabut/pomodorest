...
<div class="circleBckgr" id="circleBckgr9"></div>
  ...
  <h1 class="section-heading">NUSTATYMAI</h1>
    <div id="input-fields" class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6 ps-5">
      <form  method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
      <div class="row mb-2 align-items-center col-12 ms-1">
        ...
        <div class="col-4 text-center">
          ...
          <div class="col-3 col-sm-3 col-md-2 col-lg-2 col-xl-2 col-xxl-2 text-start">
      ...
      if($_SESSION['loggedIn'] === true) {
        ...
        <div class="col-3">
          ...
          <div class="row ms-1 align-items-center justify-content-center mt-5 mt-sm-5 mt-md-3 mt-lg-3 mt-xl-3 mt-xxl-3 col-12 mb-2">
          <button class="btn btn-lg  col-6 col-sm-6 col-md-4 col-lg-4 col-xl-4 col-xxl-4  text-center" type="submit" id="buttonSettings" name="buttonSettings">Išsaugoti nustatymus</button>
      </div>;';}?>

      <div class="row mb-2 fs-3 align-items-center text-center col-12 mb-2">
        <?php
        if($_SESSION['loggedIn'] === true) {
          echo '<div class="logout row col-12 mt-2 mt-sm-2 mt-md-3 mt-lg-3 mt-xl-3 mt-xxl-3 ms-2" id="logout"><h4 ><u>X Atsijungti</u></h4></div>';
          /*echo '<script>
