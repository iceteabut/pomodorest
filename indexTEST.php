...
if ($_SESSION['userEmail'] == null) {
  ...
  if (!isset($_SESSION['workInterval']) || $_SESSION['workInterval']==null )  $_SESSION['workInterval'] = 0.1;
  if (!isset($_SESSION['restInterval']) || $_SESSION['restInterval']==null )  $_SESSION['restInterval'] = 0.1;
...
<html>
  ...
  <header class="header">
      ...
      <nav class="navbar navbar-expand-md  ">
          ...
          echo '<span class="float-left  col-6 col-sm-5 col-md-2 " ><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-box-arrow-in-left logout" viewBox="0 0 16 16">
...
<div class="circleContainer2" id="circleContainer3">
     <div class="circle2  pt-5 text-wrap d-flex flex-column align-items-center justify-content-center " id="circle3">
        ...
        <div class="title "><h4>Stapleris, poperius, žirklės</h4></div>
         <div class="score fs-4 row mt-2">  
        ...
        <div class="move fs-4 row mb-2">Pasirinkite savo ėjimą</div>
  ...
  <section id="timer">
    ...
    <div class="circleBckgr" id="circleBckgr1">
      <div id="flower"></div>
    </div>
...
if ($resultTips->num_rows > 0) {
    ...
    while ($row = $resultTips->fetch_assoc()) {
        echo '<div class="circleRest text-wrap">';
   ...
   <div class=" taskAdd mb-5 col-6 offset-4">
    ...
    <div class="row">
      ...
      if($_SESSION['loggedIn'] === true) {
          ...
          <button class="btn   col-3  text-center" type="submit" id="buttonTasks" name="'.$btnName.'">'.$btnText.'</button>
      </div>;';}?>
    ...
    <div id="input-fields" class="col-6 ps-5">
      ...
      <div class="row mb-2 align-items-center col-12 ms-1">
        ...
        <div class="col-4 text-center">
            <div class="dropdown">
              <button class="dropdownButton btn btn-secondary dropdown-toggle sessionButton col-12 py-3" name="timerMode" type="button"  data-bs-toggle="dropdown" aria-expanded="false">
      ...
      <div class="row mb-2 align-items-center col-12 ms-1">
        ...
        <div class="col-2 text-center">
            ...
            <input type="number" name="workInterval" class="form-control p-3 sessionInput workInterval" id="work" value="<?php echo $_SESSION['workInterval'];?>" step="0.1" min="0.1" max="1440">
          
        </div>
        <div class="col-2 text-center">
          
          <input type="number" name="restInterval" class="form-control p-3 sessionInput restInterval" id="break" value="<?php echo $_SESSION['restInterval'];?>"  step="0.1" min="0.1" max="1440">
      ...
      <div class="row mb-2 align-items-center col-12 ms-1">
        ...
        <div class="col-4 text-center">
            <div class="dropdown">
              <button class="dropdownButton2 sessionButton btn btn-secondary dropdown-toggle col-12 py-3" name="colorTheme" type="button" data-bs-toggle="dropdown" aria-expanded="false">
...
<div class="circleBckgr" id="circleBckgr11"></div>
  ...
  <h1 class="section-heading">STATISTIKA</h1>
    ...
    <div class=" row  text-center" >
      <div class="col col-1  "></div>
        <h4  class="col col-7 m-1 text-start " name="statName" id="statFullName">Pilnai įvykdytos dienos:</h4>
      ...
      <div class=" row mb-1 pt-2 text-center" >
        <div class="col col-1  "></div>
          <h4  class="col col-7 m-1 text-start " name="statName" id="statPartName">Sėkmingų savaičių:</h4>
      ...
      <div class=" row mb-1 pt-2 text-center" >
      <div class="col col-1  "></div>
        <h4  class="col col-7 m-1 text-start " name="statName" id="statPartName">Dirbta dienų šią savaitę :</h4>
    ...
    <div class=" row mb-1 pt-2 text-center" >
    <div class="col col-1  "></div>
      <h4  class="col col-7 m-1 text-start " name="statName" id="statPartName">Sėkmingų dienų:</h4>
  ...
  <div class=" row mb-1 pt-2 text-center" >
  <div class="col col-1  "></div>
    <h4  class="col col-7 m-1 text-start " name="statName" id="statPartName">Dirbta minučių šiandien :</h4>
    ...
    <div class="col col-1 ms-0 pt-2">
      ...
      <div class=" row mb-1 pt-2 text-center" >
        <div class="col col-1  "></div>
        <h4  class="col col-7 m-1 text-start " name="statName" id="statNoneName">Dirbta laiko, min:</h4>
      ...
      <div class=" row mb-1 pt-2 text-center" >
        <div class="col col-1  "></div>
        <h4  class="col col-7 m-1 text-start " name="statName" id="statRoundsName">Įveikta etapų:</h4>
  ...
  ?>
    ...
    <script src="scriptTEST.js" data-loggedin="<?php echo $_SESSION['loggedIn']; ?>"></script>
